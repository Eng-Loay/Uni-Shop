...
const CustomAppBar = styled(MuiAppBar)(({ theme }) => ({
  ...
  "& .MuiToolbar-root": {
    minHeight: "48px", // Change Toolbar height
  },
}));
...
const NAVIGATION = [
  ...
  },
  {
    segment: "orders",
    title: "Orders",
    icon: <BallotIcon style={{ color: "#ffffff" }} />,
  },
  {
    segment: "information",
    title: "Information",
    icon: <FeedIcon style={{ color: "#ffffff" }} />,
  },
  {
    segment: "logOut",
    title: "Log Out",
    icon: <LogoutIcon style={{ color: "#ffffff" }} />,
  },
  { kind: "divider" },
  ...
  },
  {
    ...
    title: "Integrations",
    icon: <LayersIcon style={{ color: "#ffffff" }} />,
  },
];
